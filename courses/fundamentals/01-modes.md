...
一覧から選びたいときは、入力欄左下の**モード名をクリック**するか `Cmd + .` でメニューを開きます。
...
| モード | 向いていること | ファイル編集 |
|--------|----------------|--------------|
| **Agent**（`⌘I`） | 機能追加・リファクタ・バグ修正・テスト実行 | する |
...
- Skill を選んで **`Option + Enter`**（Windows は `Alt + Enter`）、またはメニューの **Use as Mode**
